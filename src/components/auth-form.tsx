            ...
            {view === 'phone' ? (
                ...
                <form onSubmit={phoneForm.handleSubmit(handleSendOtp)} className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <Input id="phone-input" type="tel" placeholder="+1 234 567 890" {...phoneForm.register('phone')} className="pl-10 !bg-background/50" />
                    </div>
                ...
                <form onSubmit={otpForm.handleSubmit(handleVerifyOtp)} className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <Input id="otp-input" type="text" placeholder="123456" {...otpForm.register('otp')} className="pl-10 !bg-background/50" />
                    </div>
